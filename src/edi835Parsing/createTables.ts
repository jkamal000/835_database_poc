...
export function create835Tables(): SqliteDatabaseType {
  ...
  db.prepare(
    `CREATE TABLE IF NOT EXISTS ${segmentTables.BPR_TABLE} (
      ...
      payment_method_code                       VARCHAR(3) NOT NULL,        -- BPR-04
  ...
  db.prepare(
    `CREATE TABLE IF NOT EXISTS ${compositeTables.C040_TABLE} (
      ...
      id_qualifier_1        VARCHAR(3),             -- C040-01
      id_1                  VARCHAR(80),            -- C040-02
      id_qualifier_2        VARCHAR(3),             -- C040-03
      id_2                  VARCHAR(80),            -- C040-04
      id_qualifier_3        VARCHAR(3),             -- C040-05
      id_3                  VARCHAR(80),            -- C040-06
